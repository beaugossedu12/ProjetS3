...
public class Etudiant4Choix2  extends VerticalLayout {
   ...
   private IntegerField m1;
    ...
    public Etudiant4Choix2(VuePrincipale main) {
        ...
        int a=0;
        try{
        int id = bdd2.createVoeux(this.main.getConBdD(), 2,this.main.getSessionInfo().getUserID(), a, a, a);
        this.newVoeux = new Voeux(id,2,this.main.getSessionInfo().getUserID(),a,a,a);
