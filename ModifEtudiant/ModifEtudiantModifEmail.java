        ...
        //try (Connection con = testConnect()) {
            ...
            enregistrer.addThemeVariants(ButtonVariant.LUMO_PRIMARY);
             this.enregistrer.addClickListener(event -> { 
                 ...
                 Etudiant newEtudiant = new Etudiant(trouveIdEtudiant(this.main.getConBdD(),this.nom.getValue()),this.nom.getValue(),trouvePrenomEtudiant(this.main.getConBdD(), this.nom.getValue()),this.email.getValue(),Etudiant.trouveMdpEtudiant(this.main.getConBdD(), this.nom.getValue()));
